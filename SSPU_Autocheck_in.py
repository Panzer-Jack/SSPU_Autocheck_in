# 二工大校园网自动签到- Linux-RashperryPi Version (Panzer_Jack)
# https://panzer-jack.cn/
...
class SchoolAutoCheckIn:
    def __init__(self, SSPU_AccountData):
        ...
        # IP伪装
        # self.opt.add_argument("--proxy-server=http://183.147.30.68:9000")
        ...
        # 打开网页
        self.driver = selenium.webdriver.Chrome(executable_path='chromedriver.exe', options=self.opt)
...
if __name__ == '__main__':
    ...
    for i in range(0, len(SSPU_AccountData_Holiday)):
        sspu = SchoolAutoCheckIn(SSPU_AccountData=SSPU_AccountData_Holiday[i])
